...
public class CourseQuizRefActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_course_quiz_ref);
        ...
        WebView webView = (WebView) findViewById(R.id.course_quiz_ref_intro_webview);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setWebChromeClient(new WebChromeClient());
        webView.loadUrl("file:///android_asset/www/course_quiz_ref_introduction.html");
    }
