...
public class UserInterfaceQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_interface_quiz);
        ...
        WebView webView = (WebView) findViewById(R.id.ui_quiz_webview);
        UserInterfaceQuizActivity.JavaScriptInterface myJavaScriptInterface =
                new UserInterfaceQuizActivity.JavaScriptInterface(this, webView);

        webView.getSettings().setJavaScriptEnabled(true);
        WebView.setWebContentsDebuggingEnabled(true);
        webView.addJavascriptInterface(myJavaScriptInterface, "UserInterfaceQuiz");
    ...
    public class JavaScriptInterface {
        ...
        public JavaScriptInterface(UserInterfaceQuizActivity userInterfaceQuizActivity, WebView mWebView) {
            parentActivity = userInterfaceQuizActivity;
            webView = mWebView;
        }
    ...
    private void initiateCancelQuizDialog() {
        ...
        dialog = new Dialog(UserInterfaceQuizActivity.this, R.style.Theme_Dialog_Cancel_Btn);
        ...
        leaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent myIntent = new Intent(getApplicationContext(), UserInterfaceQuizInfoActivity.class);
    ...
    private void initiateSubmitQuizDialog(final String[] answers, final int counts) {
        ...
        } else if (counts != 4 && (4 - counts) != 1) {
            title.setText("There are " + (4 - counts) + " questions that you didn't answer. "
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent myIntent = new Intent(getApplicationContext(), UserInterfaceQuizResultsActivity.class);
                startActivity(myIntent);
            }
        });
    }
    ...
    private void calculatePoints(String[] answers, int counts) {
        ...
        if (userInterfaceQuizPtsFromDB == 0) {
            ...
            finalPoints = totalPtsFromDB - userInterfaceQuizPtsFromDB + points;
        }
