...
public class IntentQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intent_quiz);
        ...
        WebView webView = (WebView) findViewById(R.id.intent_quiz_webview);
        JavaScriptInterface myJavaScriptInterface = new JavaScriptInterface(this, webView);

        webView.getSettings().setJavaScriptEnabled(true);
        WebView.setWebContentsDebuggingEnabled(true);
        webView.addJavascriptInterface(myJavaScriptInterface, "IntentQuiz");
        webView.setWebChromeClient(new WebChromeClient());
        webView.loadUrl("file:///android_asset/www/intent_quiz.html");
    }
    ...
    public class JavaScriptInterface {
        ...
        private IntentQuizActivity parentActivity;
        private WebView webView;

        public JavaScriptInterface(IntentQuizActivity intentQuizActivity, WebView mWebView) {
            parentActivity = intentQuizActivity;
            webView = mWebView;
        }
    ...
    private void initiateSubmitQuizDialog(final String[] answers, final int counts) {
        ...
        dialog = new Dialog(IntentQuizActivity.this, R.style.Theme_Dialog_Cancel_Btn);
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent myIntent = new Intent(getApplicationContext(), IntentQuizResultsActivity.class);
    ...
    private void calculatePoints(String[] answers, int counts) {
        ...
        if (intentQuizPtsFromDB == 0) {
            ...
            finalPoints = totalPtsFromDB - intentQuizPtsFromDB + points;
        }
    ...
    private void initiateCancelQuizDialog() {
        ...
        leaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent myIntent = new Intent(getApplicationContext(), IntentQuizInfoActivity.class);
                startActivity(myIntent);
            }
        });
