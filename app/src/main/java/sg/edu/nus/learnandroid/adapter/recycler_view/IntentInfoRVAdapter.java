...
import sg.edu.nus.learnandroid.activity.intent.IntentIntroActivity;
import sg.edu.nus.learnandroid.activity.intent.IntentPassDataActivity;
import sg.edu.nus.learnandroid.activity.intent.IntentQuizInfoActivity;
...
public class IntentInfoRVAdapter extends RecyclerView.Adapter<IntentInfoRVAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if (buttonName.equals("Data Passing")) {
            viewHolder.buttonPRL.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent editProfileIntent = new Intent(view.getContext(), IntentPassDataActivity.class);
                    context.startActivity(editProfileIntent);
                    activity.overridePendingTransition(R.anim.slide_from_right, R.anim.slide_to_left);
                }
            });

            viewHolder.buttonIconIV.setImageResource(R.drawable.pass_data);
        }
